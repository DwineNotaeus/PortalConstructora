...
export class ShowHidePasswordDirective {
  ...
  toggle(span: HTMLElement) {
    ...
    if (this._shown) {
      ...
      span.innerHTML = "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-eye-slash' viewBox='0 0 16 16'>"
      ...
      span.innerHTML = "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-eye' viewBox='0 0 16 16'>"
